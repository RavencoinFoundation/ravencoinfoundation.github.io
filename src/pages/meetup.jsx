      ...
      <StyledMeetup>
        <Container>
          <h2>
            ...
            <p>
            I don't know <strong>WHY</strong> Ravencoin attracts the best people in the world.  I only know that it <strong>DOES</strong>.</p>
            <p>
            </p>
            It's time to get together to discuss, collaborate, and celebrate Ravencoin.
            <p>
            <strong>Where:</strong> Aboard the Carnival Horizon</p>
            <strong>When:</strong> Nov 13, 2021 - Nov 21, 2021
            <strong>Who:</strong> The Ravencoin community -- that's you.
